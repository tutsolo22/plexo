      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          {events.length === 0 ? (
            ...
            events.map((event) => (
              <div key={event.id} className="flex items-start space-x-3 p-3 rounded-lg border hover:bg-muted/50 transition-colors">
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          {quotes.length === 0 ? (
            ...
            quotes.map((quote) => (
              <div key={quote.id} className="flex items-start justify-between p-3 rounded-lg border hover:bg-muted/50 transition-colors">
                <div className="flex-1 min-w-0">
                ...
                <div className="text-right">
                  <p className="text-sm font-semibold">
                    Q{typeof quote.total === 'number' ? quote.total.toFixed(2) : quote.total.toFixed(2)}
                  </p>
                </div>
              </div>
            ))
