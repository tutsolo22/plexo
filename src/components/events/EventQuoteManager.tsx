...
const EventQuoteManager: React.FC<EventQuoteManagerProps> = ({
  ...
  const handleCreateQuote = async () => {
    ...
    if (
      ...
      (formData.packages[0] && formData.packages[0].price <= 0)
    ) {
  ...
  const calculateTotal = () => {
    ...
    const adjustmentsTotal = formData.adjustments.reduce(
      (sum, adj) => sum + (adj.type === 'discount' ? -adj.amount : adj.amount),
      0
    );
      ...
      {needsSync() && (
        <Alert className='border-orange-200 bg-orange-50'>
          ...
          <AlertDescription className='text-orange-800'>
            <div className='mb-1 font-medium'>Se requiere sincronización:</div>
        ...
        <Card>
          ...
          <CardContent className='space-y-4'>
            ...
            <div className='rounded-lg border border-gray-200 p-4'>
              <h4 className='mb-3 font-medium'>Paquete Principal</h4>
            ...
            <div>
              ...
              {formData.adjustments.map((adjustment, index) => (
                <div key={index} className='mb-2 rounded-lg border border-gray-200 p-3'>
            ...
            <div className='flex items-center space-x-4'>
              ...
              {formData.autoSend && (
                <select
                  ...
                  onChange={e =>
                    setFormData(prev => ({ ...prev, emailTemplate: e.target.value as any }))
                  }
                >
            ...
            <div className='flex justify-end space-x-2'>
              ...
              <Button onClick={handleCreateQuote} disabled={creating || !formData.title.trim()}>
        ...
        {quotes.length === 0 ? (
          <Card>
            <CardContent className='p-8 text-center'>
              ...
              <h3 className='mb-2 text-lg font-medium text-gray-900'>No hay cotizaciones</h3>
              <p className='mb-4 text-gray-600'>Este evento aún no tiene cotizaciones asociadas.</p>
                ...
                <div className='flex items-start justify-between'>
                  <div className='flex-1'>
                    ...
                    {(quote as any).description && (
                      <p className='mt-2 text-sm text-gray-600'>{(quote as any).description}</p>
                    )}
